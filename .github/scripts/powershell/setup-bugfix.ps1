...
.DESCRIPTION
  Determines repository context and emits JSON or human-readable output for bugfix planning agent.
.PARAMETER Json
  Emit JSON output.
.PARAMETER Help
  Show usage help.
...
if ($Help) {
  Write-Output "Usage: ./setup-bugfix.ps1 [-Json] [-Help]"
...
$agentVersion = 'bugfix-plan-agent-1.0'
